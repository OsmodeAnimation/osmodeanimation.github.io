/*
    ...
    This file is part of Itch.

    Itch is free software: you can redistribute it and/or modify
    ...
    ypr-Itch project conversion and countless bugfixes
...
IDE_Morph.prototype.createLogo = function () {
    ...
    this.logo.texture = "data:image/png;base64,";
    ...
    if (costume.isTainted()) {
        this.inform(
            ...
            'The picture you wish to import has been\n' +
                ...
                'making it unusable for costumes in Itch. \n\n' +
...
IDE_Morph.prototype.snapMenu = function () {
    ...
    menu.addItem(
        'Itch website',
        () => window.open('itch.html', 'SnapWebsite')
    );
    menu.addItem(
        'Download source',
        () => window.open(
...
IDE_Morph.prototype.resourceURL = function () {
    ...
    // Default Itch simply returns a path (relative to snap.html)
...
IDE_Morph.prototype.aboutSnap = function () {
    ...
    aboutTxt = 'Itch 6.5.2\nBuild Your Own Blocks\n\n'
        ...
        + '        Itch is developed by the University of California, '
        + 'Berkeley and SAP        \n'
        + 'with support from the National Science Foundation (NSF),\n'
        + 'MIOsoft and YC Research.\n'
        + 'The design of Itch is influenced and inspired by Scratch,\n'
    ...
    noticeTxt = localize('License')
        ...
        + 'Want to use Itch but scared by the open-source license?\n'
...
IDE_Morph.prototype.save = function () {
    ...
    // when running Itch locally without a web server
    if (location.protocol === 'file:') {
        if (this.projectName) {
...
IDE_Morph.prototype.openProjectsBrowser = function () {
    if (location.protocol === 'file:') {
        ...
        // to access the cloud even when running Itch locally
    ...
    if (this.isIE()) {
        ...
        txt = new TextMorph(
            'Please do not use Internet Explorer.\n' +
                'Itch runs best in a web-standards\n' +
                'compliant browser',
            dlg.fontSize,
            dlg.fontStyle,
            true,
...
CamSnapshotDialogMorph.prototype.notSupportedMessage =
	...
	'Some browsers also require you to access Itch\n' +
